...
public final class ProjectUtils {
	...
	public static final void printArrayElements(List<Element> listOfElements,String message){
...
//		System.out.println();
	...
	public static final void printArrayElements(Element[] listOfElements,String message){
//		System.out.print(message+ "  ");
...
//		System.out.println();
	...
	public static BigInteger[] createBigIntArr(int r1, int r2) {
		...
		for( int r = r1; r<=r2; r++){	
			/*String s1 = "" + Math.pow(10,r);
			System.out.println(s1 + ", " + s1.length());
			arr[r-r1] = new BigInteger(s1.substring(0, s1.length()-2));*/
